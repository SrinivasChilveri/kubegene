...
func (in *ConditionInfo) DeepCopyInto(out *ConditionInfo) {
	*out = *in
	if in.RspMatch != nil {
		in, out := &in.RspMatch, &out.RspMatch
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConditionInfo.
func (in *ConditionInfo) DeepCopy() *ConditionInfo {
	if in == nil {
		return nil
	}
	out := new(ConditionInfo)
	in.DeepCopyInto(out)
	return out
}
